...
UserService.createUser = (first_name, last_name,email,firebase_token, avatar_url, income) => {
    ...
    return getDbConn(dbAddr).one(sql,{first_name, last_name,email,firebase_token, avatar_url, income})
}
...
UserService.updateUser = (first_name, last_name, email, firebase_token, avatar_url, income, id) => {
    ...
    return getDbConn(dbAddr).one(sql,{first_name, last_name, email, firebase_token, avatar_url, income, id});
}
